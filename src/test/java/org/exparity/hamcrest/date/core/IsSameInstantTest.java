...
public class IsSameInstantTest {
    ...
    public void isDateSameInstantAsNull() {
        assertThat(JUN_15_2012_11PM_AS_DATE, DateMatchers.sameInstant(null));
    }
    ...
    @Test(expectedExceptions = AssertionError.class, expectedExceptionsMessageRegExp = ASSERTION_PATTERN)
    public void isLocalDateTimeSameInstantNullLocalDateTime() {
        assertThat(AUG_04_2015_NOON, LocalDateTimeMatchers.sameInstant(null));
    }
    ...
    @Test(expectedExceptions = AssertionError.class, expectedExceptionsMessageRegExp = ASSERTION_PATTERN)
    public void isZonedDateTimeSameInstantNullZonedDateTime() {
        assertThat(AUG_04_2015_NOON_UTC, ZonedDateTimeMatchers.sameInstant(null));
    }
