...
public class IsSameDayTest {
    ...
    @Test(expectedExceptions = AssertionError.class, expectedExceptionsMessageRegExp = ASSERTION_PATTERN)
    public void isDateSameDayNull() {
        assertThat(JUN_15_2012_11AM_AS_DATE, DateMatchers.sameDay((Date) null));
    }
    ...
    @Test(expectedExceptions = AssertionError.class, expectedExceptionsMessageRegExp = ASSERTION_PATTERN)
    public void isDateSameDayNullLocalDate() {
        assertThat(JUN_15_2012_11AM_AS_DATE, DateMatchers.sameDay((LocalDate) null));
    }
    ...
    @Test(expectedExceptions = AssertionError.class, expectedExceptionsMessageRegExp = ASSERTION_PATTERN)
    public void isLocalDateSameDayNullLocalDate() {
        assertThat(AUG_04_2015, LocalDateMatchers.sameDay(null));
    }
    ...
    @Test(expectedExceptions = AssertionError.class, expectedExceptionsMessageRegExp = ASSERTION_PATTERN)
    public void isLocalDateTimeSameDayNullLocalDateTime() {
        assertThat(AUG_04_2015_NOON, LocalDateTimeMatchers.sameDay(null));
    }
    ...
    @Test(expectedExceptions = AssertionError.class, expectedExceptionsMessageRegExp = ASSERTION_PATTERN)
    public void isZonedDateTimeSameDayNullZonedDateTime() {
        assertThat(AUG_04_2015_NOON_UTC, ZonedDateTimeMatchers.sameDay(null));
    }
