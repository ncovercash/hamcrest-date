...
public class IsMonthTest {
    ...
    public void isDateNull() {
        assertThat(JAN_01_2015_NOON_AS_DATE, DateMatchers.isMonth(null));
    }
    ...
    @Test(expectedExceptions = AssertionError.class, expectedExceptionsMessageRegExp = ASSERTION_PATTERN)
    public void isDateNotSameMonthAsNull() {
        assertThat(JAN_01_2015_NOON_AS_DATE, DateMatchers.sameMonth((Months) null));
    }
