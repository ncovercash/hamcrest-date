...
public class IsSameMonthOfYearTest {
    ...
    @Test(expectedExceptions = AssertionError.class, expectedExceptionsMessageRegExp = ASSERTION_PATTERN)
    public void isDateNotSameMonthOfMonth() {
        assertThat(new Date(), DateMatchers.sameMonth((Date) null));
    }
    ...
    @Test(expectedExceptions = AssertionError.class, expectedExceptionsMessageRegExp = ASSERTION_PATTERN)
    public void isDateNotSameMonthOfYearOfNull() {
        assertThat(new Date(), DateMatchers.sameMonthOfYear((Date) null));
    }
    ...
    @Test(expectedExceptions = AssertionError.class, expectedExceptionsMessageRegExp = ASSERTION_PATTERN)
    public void isLocalDateNotSameMonthOfYearOfNull() {
        assertThat(LocalDate.now(), LocalDateMatchers.sameMonthOfYear(null));
    }
    ...
    @Test(expectedExceptions = AssertionError.class, expectedExceptionsMessageRegExp = ASSERTION_PATTERN)
    public void isLocalDateTimeNotSameMonthOfYearOfNull() {
        assertThat(LocalDateTime.now(), LocalDateTimeMatchers.sameMonthOfYear(null));
    }
    ...
    @Test(expectedExceptions = AssertionError.class, expectedExceptionsMessageRegExp = ASSERTION_PATTERN)
    public void isZonedDateTimeNotSameMonthOfYearOfNull() {
        assertThat(ZonedDateTime.now(), ZonedDateTimeMatchers.sameMonthOfYear(null));
    }
