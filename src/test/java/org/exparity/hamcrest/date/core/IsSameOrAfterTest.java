...
public class IsSameOrAfterTest {
    ...
    @Test(expectedExceptions = AssertionError.class, expectedExceptionsMessageRegExp = ASSERTION_PATTERN)
    public void isDateSameOrAfterNullDate() {
        assertThat(JUN_15_2012_11AM_AS_DATE, DateMatchers.sameOrAfter((Date) null));
    }
    ...
    @Test(expectedExceptions = AssertionError.class, expectedExceptionsMessageRegExp = ASSERTION_PATTERN)
    public void isDateSameOrAfterNullLocalDate() {
        assertThat(JUN_15_2012_11AM_AS_DATE, DateMatchers.sameOrAfter((LocalDate) null));
    }
    ...
    @Test(expectedExceptions = AssertionError.class, expectedExceptionsMessageRegExp = ASSERTION_PATTERN)
    public void isLocalDateSameOrAfterNullLocalDate() {
        assertThat(AUG_04_2015, LocalDateMatchers.sameOrAfter(null));
    }
    ...
    @Test(expectedExceptions = AssertionError.class, expectedExceptionsMessageRegExp = ASSERTION_PATTERN)
    public void isLocalDateTimeSameOrAfterNullLocalDateTime() {
        assertThat(AUG_04_2015_NOON, LocalDateTimeMatchers.sameOrAfter(null));
    }
    ...
    @Test(expectedExceptions = AssertionError.class, expectedExceptionsMessageRegExp = ASSERTION_PATTERN)
    public void isZonedDateTimeSameOrAfterNullZonedDateTime() {
        assertThat(AUG_04_2015_NOON_UTC, ZonedDateTimeMatchers.sameOrAfter(null));
    }
    ...
    @Test(expectedExceptions = AssertionError.class, expectedExceptionsMessageRegExp = ASSERTION_PATTERN)
    public void isLocalTimeSameOrAfterNullLocalTime() {
        assertThat(LocalTime.NOON, LocalTimeMatchers.sameOrAfter(null));
    }
