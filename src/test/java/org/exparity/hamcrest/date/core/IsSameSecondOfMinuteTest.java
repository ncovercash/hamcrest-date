...
public class IsSameSecondOfMinuteTest {
    ...
    @Test(expectedExceptions = AssertionError.class, expectedExceptionsMessageRegExp = ASSERTION_PATTERN)
    public void isDateSameSecondNull() {
        assertThat(new Date(), DateMatchers.sameSecond(null));
    }
    ...
    @Test(expectedExceptions = AssertionError.class, expectedExceptionsMessageRegExp = ASSERTION_PATTERN)
    public void isDateNotSameSecondOfNull() {
        assertThat(new Date(), DateMatchers.sameSecondOfMinute(null));
    }
    ...
    @Test(expectedExceptions = AssertionError.class, expectedExceptionsMessageRegExp = ASSERTION_PATTERN)
    public void isLocalDateTimeNotSameSecondOfMinuteNull() {
        assertThat(LocalDateTime.now(), LocalDateTimeMatchers.sameSecondOfMinute(null));
    }
    ...
    @Test(expectedExceptions = AssertionError.class, expectedExceptionsMessageRegExp = ASSERTION_PATTERN)
    public void isLocalTimeNotSameSecondOfMinuteNull() {
        assertThat(LocalTime.now(), LocalTimeMatchers.sameSecondOfMinute(null));
    }
    ...
    @Test(expectedExceptions = AssertionError.class, expectedExceptionsMessageRegExp = ASSERTION_PATTERN)
    public void isZonedDateTimeNotSameSecondOfMinuteNull() {
        assertThat(ZonedDateTime.now(), ZonedDateTimeMatchers.sameSecondOfMinute(null));
    }
