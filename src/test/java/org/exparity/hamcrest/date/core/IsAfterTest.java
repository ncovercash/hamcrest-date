...
public class IsAfterTest {
    ...
    @Test(expectedExceptions = AssertionError.class, expectedExceptionsMessageRegExp = ASSERTION_PATTERN)
    public void isDateAfterNullDate() {
        assertThat(JUN_15_2012_11PM_AS_DATE, DateMatchers.after((Date) null));
    }
    ...
    @Test(expectedExceptions = AssertionError.class, expectedExceptionsMessageRegExp = ASSERTION_PATTERN)
    public void isDateAfterNullLocalDate() {
        assertThat(JUN_15_2012_11PM_AS_DATE, DateMatchers.after((LocalDate) null));
    }
    ...
    @Test(expectedExceptions = AssertionError.class, expectedExceptionsMessageRegExp = ASSERTION_PATTERN)
    public void isLocalDateAfterNullLocalDate() {
        assertThat(AUG_04_2015, LocalDateMatchers.after((LocalDate) null));
    }
    ...
    @Test(expectedExceptions = AssertionError.class, expectedExceptionsMessageRegExp = ASSERTION_PATTERN)
    public void isLocalDateTimeAfterNullLocalDateTime() {
        assertThat(AUG_04_2015_NOON, LocalDateTimeMatchers.after((LocalDateTime) null));
    }
    ...
    @Test(expectedExceptions = AssertionError.class, expectedExceptionsMessageRegExp = ASSERTION_PATTERN)
    public void isZonedDateTimeAfterNullZonedDateTime() {
        assertThat(AUG_04_2015_NOON_UTC, ZonedDateTimeMatchers.after((ZonedDateTime) null));
    }
