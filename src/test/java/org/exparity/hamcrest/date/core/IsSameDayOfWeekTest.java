...
public class IsSameDayOfWeekTest {
    ...
    @Test(expectedExceptions = AssertionError.class, expectedExceptionsMessageRegExp = ASSERTION_PATTERN)
    public void isDateNotSameDayOfWeekOfNull() {
        assertThat(AUG_04_2015_NOON_AS_DATE, DateMatchers.sameDayOfWeek(null));
    }
    ...
    @Test(expectedExceptions = AssertionError.class, expectedExceptionsMessageRegExp = ASSERTION_PATTERN)
    public void isLocalDateNotSameDayOfWeekOfNull() {
        assertThat(AUG_04_2015, LocalDateMatchers.sameDayOfWeek(null));
    }
    ...
    @Test(expectedExceptions = AssertionError.class, expectedExceptionsMessageRegExp = ASSERTION_PATTERN)
    public void isLocalDateTimeNotSameDayOfWeekAsNull() {
        assertThat(AUG_04_2015_NOON, LocalDateTimeMatchers.sameDayOfWeek(null));
    }
    ...
    @Test(expectedExceptions = AssertionError.class, expectedExceptionsMessageRegExp = ASSERTION_PATTERN)
    public void isZonedDateTimeNotSameDayOfWeekAsNull() {
        assertThat(AUG_04_2015_NOON_UTC, ZonedDateTimeMatchers.sameDayOfWeek(null));
    }
