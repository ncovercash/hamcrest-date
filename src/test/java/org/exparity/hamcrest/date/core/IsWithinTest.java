...
public class IsWithinTest {
    ...
    @Test(expectedExceptions = IllegalArgumentException.class, expectedExceptionsMessageRegExp = "Date cannot be null")
    public void isDateWithinDateNull() {
        assertThat(AUG_04_2015_NOON_AS_DATE, DateMatchers.within(2, ChronoUnit.DAYS, (Date) null));
    }
    ...
    @Test(expectedExceptions = IllegalArgumentException.class, expectedExceptionsMessageRegExp = "Date cannot be null")
    public void isDateWithinLocalDateNull() {
        assertThat(AUG_04_2015_NOON_AS_DATE, DateMatchers.within(2, ChronoUnit.DAYS, (LocalDate) null));
    }
    ...
    @Test(expectedExceptions = IllegalArgumentException.class, expectedExceptionsMessageRegExp = "Date cannot be null")
    public void isLocalDateWithinLocalDateNull() {
        assertThat(AUG_04_2015, LocalDateMatchers.within(2, ChronoUnit.DAYS, null));
    }
    ...
    @Test(expectedExceptions = IllegalArgumentException.class, expectedExceptionsMessageRegExp = "Date cannot be null")
    public void isLocalDateTimeWithinLocalDateTimeNull() {
        assertThat(AUG_04_2015_NOON, LocalDateTimeMatchers.within(2, ChronoUnit.DAYS, null));
    }
    ...
    @Test(expectedExceptions = IllegalArgumentException.class, expectedExceptionsMessageRegExp = "Date cannot be null")
    public void isZonedDateTimeWithinZonedDateTimeNull() {
        assertThat(AUG_04_2015_NOON_UTC, ZonedDateTimeMatchers.within(2, ChronoUnit.DAYS, null));
    }
    ...
    @Test(expectedExceptions = IllegalArgumentException.class, expectedExceptionsMessageRegExp = "Time cannot be null")
    public void isLocalTimeWithSameLocalTimeNull() {
        assertThat(LocalTime.NOON, LocalTimeMatchers.within(2, ChronoUnit.SECONDS, null));
    }
