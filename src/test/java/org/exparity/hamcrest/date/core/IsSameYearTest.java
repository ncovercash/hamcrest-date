...
public class IsSameYearTest {
    ...
    @Test(expectedExceptions = AssertionError.class, expectedExceptionsMessageRegExp = ASSERTION_PATTERN)
    public void isDateNotSameYearOfNull() {
        assertThat(new Date(), DateMatchers.sameYear(null));
    }
    ...
    @Test(expectedExceptions = AssertionError.class, expectedExceptionsMessageRegExp = ASSERTION_PATTERN)
    public void isLocalDateNotSameYearOfNull() {
        assertThat(LocalDate.now(), LocalDateMatchers.sameYear(null));
    }
    ...
    @Test(expectedExceptions = AssertionError.class, expectedExceptionsMessageRegExp = ASSERTION_PATTERN)
    public void isLocalDateTimeNotSameYearOfNull() {
        assertThat(LocalDateTime.now(), LocalDateTimeMatchers.sameYear(null));
    }
    ...
    @Test(expectedExceptions = AssertionError.class, expectedExceptionsMessageRegExp = ASSERTION_PATTERN)
    public void isZonedDateTimeNotSameYearOfNull() {
        assertThat(ZonedDateTime.now(), ZonedDateTimeMatchers.sameYear(null));
    }
