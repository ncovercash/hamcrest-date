...
public class IsSameMinuteOfHourTest {
    ...
    @Test(expectedExceptions = AssertionError.class, expectedExceptionsMessageRegExp = ASSERTION_PATTERN)
    public void isDateNotSameMinuteOfNull() {
        assertThat(new Date(), DateMatchers.sameMinute(null));
    }

    @Test
    public void isDateSameMinutehDifferentHour() {
    ...
    @Test(expectedExceptions = AssertionError.class, expectedExceptionsMessageRegExp = ASSERTION_PATTERN)
    public void isLocalDateTimeNotSameMinuteOfHourOfNull() {
        assertThat(LocalDateTime.now(), LocalDateTimeMatchers.sameMinuteOfHour(null));
    }
    ...
    @Test(expectedExceptions = AssertionError.class, expectedExceptionsMessageRegExp = ASSERTION_PATTERN)
    public void isLocalTimeNotSameMinuteOfHourOfNull() {
        assertThat(LocalTime.now(), LocalTimeMatchers.sameMinuteOfHour(null));
    }
    ...
    @Test(expectedExceptions = AssertionError.class, expectedExceptionsMessageRegExp = ASSERTION_PATTERN)
    public void isZonedDateTimeNotSameMinuteOfHourOfNull() {
        assertThat(ZonedDateTime.now(), ZonedDateTimeMatchers.sameMinuteOfHour(null));
    }
